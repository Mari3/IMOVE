...
EliminateProjectionWindow::EliminateProjectionWindow(cv::Point2i position, cv::Size size, Calibration* calibration, Projection* projection) : OpenCVWindow("Eliminate projection", position, size) {
