...
{
	if(ball->pos.x < (p1->x+config.bt) && ball->pos.y > (p1->y-config.bt*5) && ball->pos.y < (p1->y+config.bt*5)){
	...
	else if(ball->pos.x > (p2->x-config.bt) && ball->pos.y > (p2->y-config.bt*5) && ball->pos.y < (p2->y+config.bt*5)){
