...
ColorHoleTimerCondition::ColorHoleTimerCondition(ColorHoleRepository *colorHoles,
                                                 LightPersonRepository *lightPeople,
                                                 const LightTrailConfiguration &config,
                                                 LightTrailRepository *lightTrails,
                                                 GravityPointRepository *gravityPoints)
        : colorHoles(colorHoles), lightPeople(lightPeople),
          config(config), timer(10.f), lightTrails(lightTrails), gravityPoints(gravityPoints) {
}
