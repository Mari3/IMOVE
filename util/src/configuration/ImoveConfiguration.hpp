...
class ImoveConfiguration {
	public:
		 ...
		 **/
		ImoveConfiguration(CameraConfiguration* camera_configuration, ProjectorConfiguration* projector_configuration, ProjectioneliminationConfiguration* projectionelimination_configuration);
